import { LocalStorageAdapter, S3StorageAdapter } from '../services/storage/storageAdapter.js';
import { globalJobQueue } from '../services/jobs/jobQueue.js';
export async function runStorageAndJobsTest() {
    ...
    globalJobQueue.registerHandler('TEST_EMAIL', async (payload) => {
